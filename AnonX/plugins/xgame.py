...
GAME_MESSAGE = "⩹━★⊷━⌞ 𝗩𝗘𝗡𝗢𝗠 • 𝙎𝙊𝙐𝙍𝘾𝙀 ⌝━⊶★━⩺\n\n★¦ مرحبا بك عزيزي:\n★¦في قسم العاب نيون\n\n⩹━★⊷━⌞ 𝗩𝗘𝗡𝗢𝗠 • 𝙎𝙊𝙐𝙍𝘾𝙀 ⌝━⊶★━⩺"
GAME_BUTTONS = [
    [ 
        InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
        InlineKeyboardButton ('نيون نيون', callback_data= 'GAME2'),
        ],[
        InlineKeyboardButton ('⌞ 𝗩𝗘𝗡𝗢𝗠 • 𝙎𝙊𝙐𝙍𝘾𝙀 ⌝⚡️', url =f"https://t.me/SOURCE_NEON")              
                 ],[
...
@app.on_message(command("رفع ابن متناكه"))
async def kaqw(client, message):
  await message.reply_text(f"تم رفع العضو\n│ \n└ʙʏ : {message.reply_to_message.from_user.mention}\n\n تم رفع ابن متناكه وكسمو عشانك😂👀")


@app.on_message(command("تنزيل ابن متناكه"))
async def yaso(client, message):
  await message.reply_text(f"تم تنزيل العضو\n│ \n└ʙʏ : {message.reply_to_message.from_user.mention}\n\n مبقاش ابن متناكه خلاص 🫣❤️")
...
async def callback_query(client, CallbackQuery):
          if CallbackQuery.data == "GAME1":
             ...
             GAME1_MESSAGE = "⩹━★⊷━⌞ 𝗩𝗘𝗡𝗢𝗠 • 𝙎𝙊𝙐𝙍𝘾𝙀 ⌝━⊶★━⩺\n\nمرحبا بك في قسم العاب نيون 3D\n\n⩹━★⊷━⌞ 𝗩𝗘𝗡𝗢𝗠 • 𝙎𝙊𝙐𝙍𝘾𝙀 ⌝━⊶★━⩺"
             ...
             GAME1_BUTTONS = [
                 [
                    ...
                    InlineKeyboardButton (
                        "°القط المجنون°" , url=f"http://t.me/gamee?game=نيونazyCat"),
                ],[
                    InlineKeyboardButton (
                        "◁" , callback_data= 'GAME')
                  ],
             ...
             await CallbackQuery.edit_message_text( 
               ...
               RETURN_GAME = "⩹━★⊷━⌞ 𝗩𝗘𝗡𝗢𝗠 • 𝙎𝙊𝙐𝙍𝘾𝙀 ⌝━⊶★━⩺\n\n★¦مرحبا بك في قسم العاب نيون\n★¦اختار ما تشاء من الالعاب مسليه وستمتع بها\n\n⩹━★⊷━⌞ 𝗩𝗘𝗡𝗢𝗠 • 𝙎𝙊𝙐𝙍𝘾𝙀 ⌝━⊶★━⩺" 

               RETURN_BUTTON = [
                    [ 
                      InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
                      InlineKeyboardButton ('★¦العاب نيون', callback_data= 'GAME2')
                      ],[
        InlineKeyboardButton ('⌞ 𝗩𝗘𝗡𝗢𝗠 • 𝙎𝙊𝙐𝙍𝘾𝙀 ⌝⚡️', url =f"https://t.me/SOURCE_NEON")              
                 ],[
                InlineKeyboardButton(
